...
public class SmartroPayModule extends ReactContextBaseJavaModule {
    ...
    public void onServiceConnected(ComponentName name, IBinder service) {
        ...
        String jsonString = "요청 JSON 예시 {\n" +
                ...
                "\"com\", \n" +
                "\"auto-detection\"],\n" +
                "\"additional-device \":\"signpad\", \"additional-device-comm\":[\n" +
                "\"com\",\n" +
                "\"auto-detection\" ],\n" +
                "\"printer-comm1\":[ \"com\",\n" +
                "\"ftdi2\",\n" +
    ...
    public void prepareSmartroPay () {
        ...
        /*
        Intent intentTemp = new Intent("smartro.vcat.action"); intentTemp.setPackage("service.vcat.smartro.com.vcat"); //Putting user-application package name. intentTemp.putExtra("package", super.getPackageName());
//To bind Interface-Constructor at Service
        mContext.bindService(intentTemp, mServiceConnectionExample, Context.BIND_AUTO_CREATE);
